...
inline int16_t read_int16_be(Iterator it) noexcept
{
    const uint8_t h = *it++;
    const uint8_t l = *it;
...
/// TODO: Move it to intx
template <typename Iterator>
inline uint16_t read_uint16_be(Iterator it) noexcept
{
    const uint8_t h = *it++;
    const uint8_t l = *it;
...
/// TODO: Move it to intx
template <typename Iterator>
inline uint32_t read_uint32_be(Iterator it) noexcept
{
    const uint8_t b3 = *it++;
    const uint8_t b2 = *it++;
    const uint8_t b1 = *it++;
